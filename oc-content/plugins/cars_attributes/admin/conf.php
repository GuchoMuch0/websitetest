                                            ...
                                            <form name="cars_form" id="cars_form" action="<?php echo osc_admin_base_url(true);?>" method="GET" enctype="multipart/form-data" >
                                                ...
                                                <?php
                                                    ...
                                                    foreach($makes as $make) {
                                                        ...
                                                        if(osc_version()<320) {
                                                            echo '<li>id - ' . $make['pk_i_id'] . ' <input name="make[' . $make['pk_i_id'] . ']" id="' . $make['pk_i_id'] . '" type="text" value="' . $make['s_name'] . '" /> <a href="' . osc_admin_base_url(true) . '?page=plugins&action=renderplugin&file='.osc_plugin_folder(__FILE__).'conf.php?section=makes&plugin_action=make_delete&id=' . $make['pk_i_id'] . '" >' . __('Delete', 'cars_attributes') . '</a> </li>';
                                                        } else {
                                                            echo '<li>id - ' . $make['pk_i_id'] . '  <input name="make[' . $make['pk_i_id'] . ']" id="' . $make['pk_i_id'] . '" type="text" value="' . $make['s_name'] . '" /> <a href="' . osc_route_admin_url('cars-admin-conf', array('section' => 'makes', 'plugin_action' => 'make_delete', 'id' => $make['pk_i_id'])) . '" >' . __('Delete', 'cars_attributes') . '</a> </li>';
                                                        }
                                                    }
                                                ?>
                                                </ul>
