<?php
    ...
    class ModelCars extends DAO
    {
        ...
        public function countCarMakesItemid($id) {
          $this->dao->select('COUNT(fk_i_make_id) AS i_count');
          $this->dao->from( $this->getTable_CarAttr() );
          $this->dao->where('fk_i_make_id', $id );
        ...
        public function maxYearsql() {
            $this->dao->select();
            $this->dao->from( $this->getTable_CarAttr() ) ;
            $this->dao->orderBy('i_year', 'DESC') ;
        ...
        public function minYearsql() {
            $this->dao->select();
            $this->dao->from( $this->getTable_CarAttr() ) ;
            $this->dao->orderBy('i_year', 'ASC') ;
            $results = $this->dao->get();
