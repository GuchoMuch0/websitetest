...
<div>
    ...
    <div class="row _20">
        ...
        ?>
        <input type="checkbox" name="warranty" id="warranty" value="1" <?php if(@$detail['b_warranty'] == 1) { echo 'checked="yes"'; } ?> /> <label for="warranty"><?php _e('Warranty', 'cars_attributes'); ?></label>
    </div>
    <div class="row _20">
        <?php
        ...
        ?>
        <input type="checkbox" name="new" id="new" value="1" <?php if(@$detail['b_new'] == 1) { echo 'checked="yes"'; } ?> /> <label for="new"><?php _e('New', 'cars_attributes'); ?></label>
    </div>
    <div class="row auto _200 _300">
        <?php
