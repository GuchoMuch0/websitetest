            ...
            <fieldset>
                ...
                <form name="osclassmail_form" id="moreedit_form" action="<?php echo osc_admin_base_url(true); ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <div style="float: right; width: 40%;">
                        <label><?php _e('Держите ваши пользователи сообщили, и до настоящего времени с письмом новостей, обновлений, статус веб-сайта, или даже сделки дня. Так что добавьте контент, нажмите кнопку Отправить и наслаждайтесь.','osclassmail'); ?></label>
                            <br/><br/><br/>
                            <b>Кому оправить письмо?</b><br /><br/>
                        <label><input type="checkbox" name="users" value="users" checked>Пользователь<br /></label>
                        <label><input type="checkbox" name="admins" value="admins" checked>Администратор</label>
                        <br/><br/><br/>
                        <b>Доступные ключевые слова:</b><br /><br/>
                        {USER_NAME} Персонализированные имя<br/>
