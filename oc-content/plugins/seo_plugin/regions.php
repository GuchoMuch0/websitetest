...
if(Params::getParam('plugin_action')=='done') {
    ...
    $detail = ModelSeoRegion::newInstance()->getAttrRegion();
    if(isset($detail['seo_region_id'])) {
        ModelSeoRegion::newInstance()->updateAttr( 1, Params::getParam('seo_title'), Params::getParam('seo_description'), Params::getParam('seo_keywords') );
    } else {
        ModelSeoRegion::newInstance()->insertAttr( 1, Params::getParam('seo_title'), Params::getParam('seo_description'), Params::getParam('seo_keywords') );
    }
...
<fieldset>
    <legend><i class="fa fa-cog"></i>&nbsp;<?php _e('Regions Settings','seo_plugin'); ?></legend>
    <br />
    <form name="promo_form" id="promo_form" action="<?php echo osc_admin_base_url(true); ?>" method="POST" enctype="multipart/form-data" >
        <input type="hidden" name="page" value="plugins" />
        <input type="hidden" name="action" value="renderplugin" />
        <input type="hidden" name="file" value="<?php echo osc_plugin_folder(__FILE__); ?>regions.php" />
        ...
        <table>
            ...
            <?php  $detail = ModelSeoRegion::newInstance()->getAttrRegion();?>
                <tr>
