...
function im_user_menu_link(){
  if(osc_current_web_theme() == 'veronika' || osc_current_web_theme() == 'stela' || osc_current_web_theme() == 'starter' ) {
...
osc_add_route('im-delete-attachment', 'im-delete-attachment/([0-9]+)/([0-9]+)/(.+)/(.+)', 'im-delete-attachment/{thread-id}/{del-att-message-id}/{del-file-name}/{secret}', osc_plugin_folder(__FILE__).'user/messages.php', $menu);
...
osc_add_route('im-ban', 'im-ban/(.+)/(.+)', 'im-ban/{action}/{block-email}', osc_plugin_folder(__FILE__).'user/threads.php', $menu);
osc_add_route('im-remove-ban', 'im-remove-ban/(.+)', 'im-remove-ban/{remove-id}', osc_plugin_folder(__FILE__).'user/threads.php', $menu);
