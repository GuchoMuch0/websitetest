                                ...
                                $lazytag ="";
                                    if ($lazy) {
                                        ...
                                        $lazytag = 'src="' . osc_resource_preview_url() . '"';
                                         // srcset="echo osc_resource_thumbnail_url() 480w, echo osc_resource_preview_url(); 768w"
                                    }
                                ?>
                                <figure class="item-photo">
                                    <a href="<?php echo osc_item_url() ; ?>" title="<?php echo osc_esc_html(osc_item_title()) ; ?>">
                                        <img title="<?php echo osc_esc_html(osc_item_title()) ; ?> " alt="<?php echo osc_esc_html(osc_item_title()) ; ?>" src="<?php echo osc_resource_preview_url(); ?>">
                                    </a>
                                </figure>
                            <?php } else { ?>
                    ...
                    <div class="item-descp">
                        ...
                        <div class="item-details">
                            <div class="item-details-row">
                                ...
                                <div class="item-detail-count"><?= osc_item_city(); ?></div>
                            </div>
                            <?php if (class_exists('ModelCars')): ?>
                ...
                <?php if(class_exists('ModelCars')): ?>
                    <div class="item-back">
                        ...
                        <div class="item-back-list">
                            <?php osc_current_web_theme_path('attributes.php'); ?>
                        </div>
                        <div class="item-back-btn">
                            <a href="<?php echo osc_item_url() ; ?>"><?php _e("View more", 'san_auto'); ?></a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="item-photos">
            <?php if( osc_images_enabled_at_items() ) { ?>
                ...
                <div class="item-attr-bottom">
                    <div class="item-count-res"><i class="flaticon-photo"></i> <?= osc_count_item_resources(); ?></div>
                </div>
        </div>
        <div class="item-property">
            <div class="item-descp">
                <?php if (!empty($make['s_name']) && !empty($model['s_name']) && !empty($attr['i_year'] )): ?>
                    ...
                    <a href="<?php echo osc_item_url() ; ?>" class="item-title" title="<?php echo osc_esc_html($titleCar) ; ?>"><?= $titleCar; ?></a>
                <?php else: ?>
                    <a href="<?php echo osc_item_url() ; ?>" class="item-title" title="<?php echo osc_esc_html(osc_item_title()) ; ?>"><?php echo osc_highlight(osc_item_title(), 100) ; ?></a>
                <?php endif; ?>
                <div class="item-details-main">
                    <?php if (isset($attr['b_new'])): ?>
            ...
            <?php if (!osc_is_ad_page()): ?>
                <div class="item-btn">
                    <div class="item-autor">
                        ...
                        <?php if( osc_price_enabled_at_items() ) { ?>
                            <div class="item-price"><?php echo osc_item_formatted_price(); ?></div>
                        <?php } ?>
